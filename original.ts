...
//notice mix of Buffer up here and Uint8Array further down!
...
export class Fill {
    ...
    static decode(payload: Buffer): Fill {
        ...
        //hardcoded indices - any change in the layout requires changing all subsequent indices
        //  hard to verify that things are correct
        //
        //alternatively, other, old parsing code used a redundant style like so:
        ...
        //no length check - if redeemerMsgLen says 100, but there's actually nothing
        //  there, we'll just get an empty subarray with no complaints because
        //  Buffer will simply adjust the end to point to the end of the buffer
...
export class FastFill {
    ...
    static decode(payload: Buffer): FastFill {
        ...
        //again - no size check and bigint conversion via ethers -> string -> bigint - brr
